...
<div class="formline">
<span>Image Resizing mode: </span>
<?php $irm=$this->getParam("IMG:resizing","yes");?>
<select name="IMG:resizing">
<option value="yes" <?php if($irm=="yes"){?>selected="selected"<?php }?>>Yes</option>
<option value="no" <?php if($irm=="no"){?>selected="selected"<?php }?>>No</option>
</select>
<span>Maximum width</span>
<input type="text"  name="IMG:resizingw" size="15" value="<?php echo $this->getParam("IMG:resizingw")?>"></input>
<span>Maximum Height</span>
<input type="text"  name="IMG:resizingh" size="15" value="<?php echo $this->getParam("IMG:resizingh")?>"></input>
<div class="fieldinfo">
The image will be resizied keeping the aspect ratio of the boundary exceeded.
</div>
</div>
<div class="formline">
